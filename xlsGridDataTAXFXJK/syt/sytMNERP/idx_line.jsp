...
<!--
  ...
  {
    var sql="select '"+idxid+"' myidxid,year||'年' tip,year||'年' 年度,round(sum(money12-money11)/10000,0)||'万' 金额 "+
    ...
    " group by year,idxitmid,idxitmnam order by year "; //and orgid='"+G_SELORG+" ','0000512677','0000317815'
    f_showtable(sql,"#",title+"按年度",bShowSum,"BYYEAR",bAddSerail);
    //document.all("BYYEAR").innerHTML = ret;
/*    var sql="select '"+idxid+"' myidxid,orgnam tip,max(orgnam) 组织,sum(money12) 金额 "+
		...
		f_showtable(sql," ",title+"按月份",bShowSum,"BYYEAR",bAddSerail);
*/		
                        ...
                        <table  cellspacing=5><tr><td>
							<table border="0" id="table6" width="100%" >
								<tr>
									...
									&nbsp;<%=strIdx%>
									&nbsp;<a href="javascript:f_selectmore();">更多的指标>></a>
									</td>
								</tr>
...
<option value="2002">2002年</option>
								...
								<tr>
									<td width="490">
<object classid="clsid:0002E55D-0000-0000-C000-000000000046" id="Chart_BYMONTH" width="723" height="176">
										<param name="XMLData" value="&lt;xml xmlns:x=&quot;urn:schemas-microsoft-com:office:excel&quot;&gt;
 &lt;x:ChartSpace&gt;
  &lt;x:OWCVersion&gt;11.0.0.5531         &lt;/x:OWCVersion&gt;
  &lt;x:Width&gt;18997&lt;/x:Width&gt;
