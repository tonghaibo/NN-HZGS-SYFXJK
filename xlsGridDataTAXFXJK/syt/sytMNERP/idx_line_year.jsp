...
//  String a_idxitemid[]={"0000000163","0000000163","0000000201","0000000201","0000000203","0000000163","0000000201","0000000201"};
...
<!--
  ...
  {
    var sql="select  year||idxid myidxid,year||'年' tip,year||'年' 年度,round(sum(money12-money11)/10000,0)||'万' 金额 "+
		" from <%=dcfinUser%>v_baseindex where idxid='"+idxid+"' and idxitmid='"+idxitmid+"' and "+
    " year>2001 and year<to_number(to_char(sysdate,'YYYY')) and orgid like '"+G_SELORG+"[PERCENT]' "+
    " group by year,idxid,idxitmid,idxitmnam order by year "; //and orgid='"+G_SELORG+" ','0000512677','0000317815'
    f_showtable(sql,"idx_line_month.jsp?yearidx=",title+"按年度",bShowSum,"BYYEAR",bAddSerail);
...
<table width="100%" height="100%" bgcolor="#2547BC"><tr><td valign=top>
		...
		<table border="0" width="100%" id="table3" height="269" cellspacing="5" cellpadding="0">
			<tr>
				<td height="142" bgcolor="#D1E2FE" valign="top" width="100%" colspan="2">
					...
					<td width="100%">
					<p align="center"><font color="#014E82">时间走势分析，统计各项指标年走势</font></td><td width="32">
					<p align="right">
...
　</td>
							...
							<table border="0"  id="table7" width="100%">
								<tr>
									...
									<td valign="top" >
									<object classid="clsid:0002E55D-0000-0000-C000-000000000046" id="Chart_BYYEAR" width="550" height="200">
   ...
   &lt;x:PlotArea&gt;
    ...
    &lt;x:Graph&gt;
     ...
     &lt;x:Series&gt;
      ...
      &lt;x:Category&gt;
       &lt;x:DataSourceIndex&gt;-1&lt;/x:DataSourceIndex&gt;
       &lt;x:Data&gt;{&amp;quot;A&amp;quot;,&amp;quot;分类 2&amp;quot;,&amp;quot;分类 3&amp;quot;,&amp;quot;分类 4&amp;quot;}&lt;/x:Data&gt;
      &lt;/x:Category&gt;
      &lt;x:Value&gt;
       &lt;x:DataSourceIndex&gt;-1&lt;/x:DataSourceIndex&gt;
       &lt;x:Data&gt;{10.0,20.0,30.0,40.0}&lt;/x:Data&gt;
      &lt;/x:Value&gt;
      &lt;x:Marker&gt;
     ...
     &lt;/x:Series&gt;
     &lt;x:Dimension&gt;
      &lt;x:ScaleID&gt;211780756&lt;/x:ScaleID&gt;
      &lt;x:Index&gt;Categories&lt;/x:Index&gt;
     &lt;/x:Dimension&gt;
     &lt;x:Dimension&gt;
      &lt;x:ScaleID&gt;211781012&lt;/x:ScaleID&gt;
      &lt;x:Index&gt;Value&lt;/x:Index&gt;
     &lt;/x:Dimension&gt;
     &lt;x:Dimension&gt;
      &lt;x:ScaleID&gt;211781232&lt;/x:ScaleID&gt;
