...
//          sUID = (String)session.getAttribute("sUID");
          ...
          String t1 = "170000";
          String t2 = "180000";
          String bascatnote = db.GetSQL("select b.note from corp a ,v_corpbascat1 b where a.extcat4=b.id and a.id='"+corpid+"'");
...
//             else 
              out.println( "<a href=\"j2mejxsitemtyp.jsp?corpid="+corpid+"&pageno="+pageno+"\">返回</a><br>" );
        }
        else {
          // 查询
...
/////////////////////////////////////////////----------------GetCorpItemWithCurORD
        ...
        /////////////////////////////////////////////----------------GetCorpItemWithCurORD
              ...
              String newline = "~n";
              out.println( "<FORM action=\"j2mejxsenterAll.jsp\" method=\"post\" >" );
...
//              if ( subtyp.equalsIgnoreCase("2") ) 
//                out.println( "<a href=\"j2mebasitemtype.jsp?corpid="+corpid+"&corpsoid="+corpsoid+"&showpage="+pageno+"\">返回1</a><br>" );
//              else 
                out.println( "<a href=\"j2mejxsitemtyp.jsp?corpid="+corpid+"&katype="+katype+"&showpage="+pageno+"\">返回</a><br>" );
