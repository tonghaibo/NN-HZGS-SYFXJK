...
function batchconv()
{
  ...
  if(datflwframe.batchconv(kemuid.value,kemuname.value,kemujsh.value,memo.value))
  {
...
&nbsp;&nbsp;备注：<input type=text id='memo' value="" size="82" />　<input type=button onclick="query();" value="条件查询" />
