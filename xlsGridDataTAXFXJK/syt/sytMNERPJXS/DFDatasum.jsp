...
<table align="center" border="0" cellspacing="1" background="images/bg_grid.gif" cellspacing="0">
    ...
    <img src="images/df-bananer.gif"/><input type='button' onclick='javascript:window.location="login.jsp";' value='退出登录' name='B1' style="border:1px solid #7F9DB9; width:60px; padding-left:4px; padding-right:4px; padding-top:1px; padding-bottom:1px; background-image: url(../xlsgrid/images/bluebk.gif);"/>
    </td>
	</tr>
	<tr>
