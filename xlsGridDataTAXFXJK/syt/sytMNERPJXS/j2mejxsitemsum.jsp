...
//     s2 += " and subtyp='1'";
    ...
    if(pageno==nPageCount)
      out.print("<a href=\"j2mejxsitemsum.jsp?showpage="+(pageno-1)+"&amp;kaflag="+kaflag+"\">上页</a></br>");
    if(pageno<nPageCount)
      out.print("<a href=\"j2mejxsitemsum.jsp?showpage="+(pageno+1)+"&amp;kaflag="+kaflag+"\">下页</a></br>");
