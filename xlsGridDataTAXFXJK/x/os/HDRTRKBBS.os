function x_HDRTRKBBS(){var pubpack = new JavaPackage ( "com.xlsgrid.net.pub" );//加载类包 
...
//var sb = new java.lang.StringBuffer();var usrinfo = new web.EAUserinfo();
{
	...
	sb.append("<table border=\"0\" width=\"100%\" height=\"100%\" cellspacing=\"0\" cellpadding=\"0\" ><tr><td width=100% height=32 style=\"border: 1px solid #DEDEDE;\">");
...
//var mwobj=grd.EAMidWareBase();var request=javax.servlet.http.HttpServletRequest();var sb = new java.lang.StringBuffer();var usrinfo = new web.EAUserinfo();
{
	...
	sb.append("<tr><td align=right width=\"100\">标题：</td><td align=left width=\"600\"><input type=\"text\" width=100%  name=\"title\" size=\"80\" style=\"border: 1px solid #CCCCCC; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px;font-size:12pt\"></td><td align=left width=\"300\">　</td></tr>");
	sb.append("<tr><td align=right width=\"100\">附件：</td><td align=left width=\"600\"><input id=\"UpLoadFile\" style=\"width:600; height:25\" name=\"UpLoadFile\" type=\"file\" /> 　</td></tr>");
	sb.append("<tr><td align=right colspan=3>");
	sb.append("<textarea name=\"content1\" style=\"width:100%;height:440;visibility:hidden;\"></textarea>");
