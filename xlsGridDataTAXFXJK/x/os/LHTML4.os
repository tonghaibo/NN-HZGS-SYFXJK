function x_LHTML4(){var pubpack = new JavaPackage ( "com.xlsgrid.net.pub" );
...
{
	if (WNDMOD == "LOGIN") return  _GetOS(db,request,deforg,WNDMOD,DSMOD,WHEREBY,SORTBY,SQLTXT ,LAYCOL ,LAYROW,MOREURL ,OSMWID,OSFUNC,OSPARAM,IFRAMEURL,IFSCROLLBAR,HTMLGUID,MOREURL,OPENLAYID);
}
