function x_test3(){	var pubpack = new JavaPackage ( "com.xlsgrid.net.pub" );
	...
	function GetLayoutHTML(db,request,sb,deforg,layoutid,ifneedhead)
	{
				...
				var stylet = "style=\"position:relative ;dddddd width:100%;height:100%;display:inline-block;*display:inline;zoom:1;min-width:"+min_width+"px;_width:"+min_width+"px;\"";
					sb.append( "\n<div id=\"PAGE_MAIN_"+layoutid+"\" "+stylet +">");//margin:"+CELLSPACE+"px;
	...
	function GetLayoutItem(db,request,sb,str,r,c,dHeight)
	{
		...
		if(deforg!="" && ctrlid!="" ) {
			...
			if(ctrlid=="IMAGE"){
				...
				//sb.append("<table  border=0 width=100% height=100% cellspacing=\""+cellspace+"\"  cellpadding=\"0\"  ><tr><td "+sStyle +" bgcolor=\""+bkcolor+"\" align="+ifnull(align,"left")+" valign="+ifnull(valign,"top")+sURLHTML+">1111"+imghtml+"</td></tr></table>" );
			}
