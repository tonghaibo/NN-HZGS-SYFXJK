function x_integration(){var pub= new JavaPackage("com.xlsgrid.net.pub");
...
function GetGrdTypList()
{
	...
	sql ="select distinct mwtyp,typ,NVL(typ,'未分类') id from sysmw where syt='"+selsytid+"' ";
	if ( typ=="REP" ) 
		sql+= " and mwtyp ='R' ";
	else if ( typ=="FORM" ) 
		sql+= " and mwtyp='F' ";
...
{
	var xml = "<?xml version='1.0' encoding='GBK'>";
	xml+= "<设计工具 mwcls=\"\" subcls=\"\" sytid=\""+selsytid+"\" typ=\""+typ+"\" todo=\"designtool\"/>";
	xml+= "<网站地图 mwcls=\"\" subcls=\"\" sytid=\""+selsytid+"\" typ=\""+typ+"\" todo=\"webmap\"/>";
	xml+= "<网站页面 mwcls=\"\" subcls=\"\" sytid=\""+selsytid+"\" typ=\""+typ+"\" todo=\"webpage\"/>";
	xml+= "<网站组件 mwcls=\"\" subcls=\"\" sytid=\""+selsytid+"\" typ=\""+typ+"\" todo=\"webcomm\"/>";
	xml+= "<组件显示风格 mwcls=\"\" subcls=\"\" sytid=\""+selsytid+"\" typ=\""+typ+"\" todo=\"commstyle\"/>";
	xml+= "<网站信息发布 mwcls=\"\" subcls=\"\" sytid=\""+selsytid+"\" typ=\""+typ+"\" todo=\"webcms\"/>";
	xml+= "<图片库 mwcls=\"\" subcls=\"\" sytid=\""+selsytid+"\" typ=\""+typ+"\" todo=\"imglib\"/>";
